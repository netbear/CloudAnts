...
public class VoldemortClient extends DB {
	...
	public int insert(String table, String key, HashMap<String, ByteIterator> values) {
		...
		HashMap<String,String> m = (HashMap<String,String>)StringByteIterator.getStringMap(values);
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        try {
            ObjectOutputStream oos = new ObjectOutputStream(bos);
            oos.writeObject(m);
            value = ByteUtils.toHexString(bos.toByteArray());
            oos.close();
        } catch(Exception ex) {
            return ERROR;
        }
	...
	public int read(String table, String key, Set<String> fields,
		...
		Versioned<HashMap<String, String>> versionedValue = null;
        Versioned<String> value = storeClient.get(key);
        byte [] byteArray = ByteUtils.fromHexString(value.getValue());
        try {
            ObjectInputStream ois = new ObjectInputStream(new ByteArrayInputStream(byteArray));
            HashMap<String, String> m = (HashMap<String,String>)ois.readObject();
            versionedValue = new Versioned<HashMap<String,String>>(m, value.getVersion());
        } catch(Exception ex) {
            return ERROR;
        }
	...
	public int update(String table, String key, HashMap<String, ByteIterator> values) {
        ...
        HashMap<String, ByteIterator> newVal = new HashMap<String, ByteIterator>();
        read(table, key, null, newVal);
